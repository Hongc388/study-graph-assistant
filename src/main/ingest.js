...
const TYPE_BY_HINT = [
  ...
  [/syllabus|handbook|module[-_ ]?(guide|info|overview|intro)|welcome|about[-_ ]?(the[-_ ]?)?module|course[-_ ]?(outline|info|guide|description)|timetable|logistics|marking[-_ ]?scheme|staff[-_ ]?contacts?/i, 'overview'],
